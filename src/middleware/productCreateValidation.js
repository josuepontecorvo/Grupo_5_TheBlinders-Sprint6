...
validations = [
    body('product').notEmpty().withMessage('Debe seleccionar una categoria de producto.'),
    body('type').notEmpty().withMessage('Debe seleccionar un tipo de producto.'),
    ...
    body('brand').notEmpty().withMessage('Debe ingresar la marca del producto'),
